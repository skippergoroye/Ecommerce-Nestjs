...
export class Helloworld1752655942681 implements MigrationInterface {
    name = 'Helloworld1752655942681'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "permission" ("roleName" character varying NOT NULL, "endpointId" integer NOT NULL, "isAllow" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_747d5f7bb514db498ee00b937ce" PRIMARY KEY ("roleName", "endpointId"))`);
